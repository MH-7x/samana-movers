...
import { localFaqs } from "@/lib/raws";
  ...
  return (
    <>
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Local Movers in Dubai",
                item: "https://www.samanamoversuae.com/local-movers-in-dubai",
              },
            ],
          }),
        }}
      ...
      <Script
        ...
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(localFaqs),
        }}
      >
        {" "}
      </Script>
        ...
        <section className="w-full h-[500px] relative ">
          ...
          <div className="flex flex-col items-start justify-center absolute w-full h-full top-0 left-0 bg-gradient-to-r from-white/75 via-white/75  md:to-white/25 to-white/50 md:px-20 px-3">
            ...
            <p className="mt-1 b-text max-w-2xl md:text-lg">
              As residential moving specialists, we ensure a seamless,
              stress-free move whether you are relocating to a high-rise in the
              Marina or a villa in Arabian Ranches.
            </p>
        ...
        <section className="grid md:grid-cols-3 grid-cols-1 gap-7 items-start mt-32 md:px-0 px-3 md:w-11/12 mx-auto">
          <div className="md:col-span-2 col-span-1 b-text">
            <Section title="Why Choose Us?">
              <p className="b-text">
                We combine local expertise with a commitment to five-star
                service. Our goal is to make your next move your easiest one
                yet.
              </p>
            ...
            >
              ...
              <p className="b-text">
                The final cost of your move depends on factors like the volume
                of your belongings (home size), the distance between locations,
                floor levels, and any additional services like full packing or
            ...
            >
              {" "}
              <p className="b-text">
                Moving in Dubai has its own set of rules. We help you navigate
                the local logistics with ease.
              </p>{" "}
              <div className="mt-10 b-text">
                <h3 className="font-medium text-xl">Pre-Move Checklist</h3>
                <p className="b-text mt-2">
                  Stay organized and stress-free with our comprehensive
                  checklist. It covers everything you need to do from four weeks
                  out to moving day itself.
                </p>
                ...
                <p className="b-text mt-2">
                  ...
                  and Downtown require you to book a service elevator and obtain
                  a move-in/move-out permit. We can guide you through the
                  process or handle the coordination with your building
                  management directly.
                </p>
                <h3 className="font-medium text-xl mt-5">
                ...
                <p className="b-text mt-2">
                  For moves in gated communities like Arabian Ranches or
                  Emirates Hills, we coordinate gate access passes for our
                  trucks and crew. We also plan for parking and safe lifting of
                  large items to avoid any disruption.
                </p>
                <h3 className="font-medium text-xl mt-5">
                  Best Times to Move in Dubai
                </h3>
                <p className="b-text mt-2">
                  To avoid traffic and heat, we recommend scheduling your move
                  for early mornings. We are fully operational during weekends
                  and can advise on the best time windows during Ramadan to
                  ensure a smooth process. As one of the top Dubai relocation
                  companies, we plan for success.
                </p>
              </div>
            </Section>
            <div className="my-10 grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          faqs={[
            {
              ...
              answer: (
                <>
                  <p>
                    Yes, your peace of mind is our top priority. All our moves
                    are protected by Goods-in-Transit insurance. This policy
                    provides comprehensive coverage for your items from the
                    moment they are in our care until they are safely delivered
                    and placed in your new home.
                  </p>
                </>
              ),
            },
            {
              ...
              answer: (
                <>
                  <p>
                    Absolutely. We have extensive experience working with
                    building management across Dubai. Our team can guide you
                    through the process of securing necessary move-in and
                    move-out permits and booking service elevators to ensure a
              ...
              answer: (
                <>
                  <p>
                    ...
                    services during Ramadan, with adjusted timings to comply
                    with local regulations and ensure a seamless and respectful
                    moving process.
                  </p>
                </>
              ),
              ...
              answer: (
                <>
                  <p>
                    ...
                    number of movers and the truck size required, the distance
                    of the move, and any extra services you choose, like full
