...
import { longDistanceFaqs } from "@/lib/raws";
  ...
  return (
    <>
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Long Distance Movers in Dubai",
                item: "https://www.samanamoversuae.com/long-distance-movers-dubai",
              },
            ],
          }),
        }}
      ...
      <Script
        ...
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(longDistanceFaqs),
        }}
      >
        {" "}
      </Script>
        ...
        <section className="w-full h-[500px] relative ">
          ...
          <div className="flex flex-col items-start justify-center absolute w-full h-full top-0 left-0 bg-gradient-to-r from-white/75 via-white/75  md:to-white/25 to-white/50 md:px-20 px-3">
            ...
            <p className="mt-5 b-text max-w-2xl md:text-lg">
              When searching for reliable long distance movers in Dubai,
              choosing the right company can make all the difference between a
              stressful ordeal and a seamless relocation experience.
            </p>
            ...
            <section className="relative isolate overflow-hidden">
              ...
              <div className="mx-auto flex w-full max-w-7xl flex-col items-center gap-6  pb-16 pt-20">
                ...
                <p className="max-w-3xl  text-base leading-7 text-gray-700 sm:text-lg">
                  ...
                  customer-centric approach, we ensure your belongings reach
                  their destination safely and on time, making us the preferred
                  choice among Dubai movers.{" "}
                  <Link
                ...
                <div className=" max-w-3xl  text text-gray-600">
                  Moving long distances requires meticulous planning,
                  specialized equipment, and experienced professionals who
                  understand the complexities of inter-emirate and international
                  relocations.
                </div>
                <div className=" max-w-3xl  text text-gray-600">
                  Whether you&lsquo;re relocating your family home from Dubai to
                  Abu Dhabi or moving your business operations across the
                  country, Samana Movers provides end-to-end moving solutions
...
"
            >
              <p>
                ...
                Dubai, Samana Movers has built a reputation for excellence
                through years of dedicated service to families and businesses
                across the UAE.
              </p>
              <p className="mt-2">
              ...
              <p className="mt-2">
                ...
                highly trained specialists who understand the unique challenges
            ...
            >
              <div className="mt-10 b-text">
                ...
                <p className="b-text mt-2">
                  Our furniture movers Dubai team handles everything from
                  delicate antiques to modern modular furniture with equal
                  expertise. We use specialized equipment and techniques to
                  ensure your furniture arrives in perfect condition.
                </p>
                ...
                <p className="b-text mt-2">
                  As professional piano movers long distance Dubai specialists,
                  we understand the intricate requirements of moving musical
                ...
                <p className="b-text mt-2">
                  ...
                  shock-resistant transportation for glass, ceramics,
                  electronics, and other delicate possessions.
                </p>
              </div>
            </Section>
            <Section
          ...
          >
            ...
            <p className="mt-5">
              Understanding long distance moving cost Dubai factors helps you
              plan your budget effectively and avoid unexpected expenses. Our
            ...
            <ul className="grid md:grid-cols-2 grid-cols-1 gap-5">
              ...
              <li>
                ...
                <p>
                  ...
                  expedited delivery may incur additional costs but provide
          ...
          >
            ...
            <ul className="grid md:grid-cols-2 grid-cols-1 gap-5">
              ...
              <li>
                ...
                <p>
                  Develop a comprehensive moving timeline that includes tasks
                  like school transfers, utility connections, and address
                  changes. This helps ensure nothing important is overlooked.
                </p>
              </li>
              <li>
                {" "}
            ...
            <ul className="grid md:grid-cols-2 grid-cols-1 gap-5">
              ...
              <li>
                ...
                <p>
                  ...
                  documents, and family heirlooms personally rather than
                  including them in the moving shipment.
                </p>
              </li>
              <li>
                {" "}
            ...
            <ul className="grid md:grid-cols-2 grid-cols-1 gap-5">
              ...
              <li>
                ...
                <p>
                  Keep all moving-related receipts and documentation for
                  insurance purposes and tax deductions if applicable.
                </p>
              </li>
              <li>
                {" "}
          ...
          faqs={[
            {
              ...
              answer: (
                <>
                  ...
                  <p>
                    For an accurate price please request a free on-site survey
                    or upload your inventory so we can provide a personalised
                    quote.
                  </p>
                </>
              ),
            ...
            {
              question:
                "What's the best time to schedule a long distance move?",
              answer: (
                <>
                  <p>
                  ...
                  <p>
                    If possible, avoid peak summer months (June–August) and
                    major public holidays to get better rates and improved
                    availability.
                  </p>
                  <p>
              ...
              answer: (
                <>
                  ...
                  <p>
                    ...
                    by customs may also be prohibited for international
                    shipments. Sensitive items will be flagged during the
                    pre-move survey.
                  </p>
                  <p>
                    We provide a full, itemised list during consultation and
                    will advise on safe alternatives or disposal options for
                    restricted goods.
                  </p>
                </>
              ),
            },
            {
              ...
              answer: (
                <>
                  ...
                  <p>
                    Additionally, we perform inventory checks, label fragile
                    items clearly and offer climate-controlled transport where
                    required.
                  </p>
                </>
              ),
            ...
            {
              question:
                "Can you help with international relocations from Dubai?",
              answer: (
                <>
                  <p>
                  ...
                  <p>
                    We work with trusted global partners and agents in
                    destination countries to ensure smooth clearance, local
                    delivery and any required permits.
                  </p>
                </>
              ),
            },
            {
              ...
              answer: (
                <>
                  <p>
                    Samana Movers combines transparent pricing, modern
                    technology (GPS tracking & digital inventory), and
                    end-to-end services including packing, crating, storage and
