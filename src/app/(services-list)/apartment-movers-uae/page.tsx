...
import { apartmentFaqs } from "@/lib/raws";
  ...
  return (
    <>
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Apartment Movers UAE",
                item: "https://www.samanamoversuae.com/apartment-movers-uae",
              },
            ],
          }),
        }}
      ...
      <Script
        ...
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(apartmentFaqs),
        }}
      >
        {" "}
      </Script>
        ...
        <section className="w-full h-[500px] relative ">
          ...
          <div className="flex flex-col items-start justify-center absolute w-full h-full top-0 left-0 bg-gradient-to-r from-white/75 via-white/75  md:to-white/25 to-white/50 md:px-20 px-3">
            ...
            <p className="mt-5 b-text max-w-2xl md:text-lg">
              ...
              relocation a breeze with transparent pricing. Whether you’re
              moving a cozy studio apartment or a spacious villa, our
          ...
          <div className="md:col-span-2 col-span-1 b-text">
            ...
            <section className="relative isolate overflow-hidden">
              ...
              <div className="mx-auto flex w-full max-w-7xl flex-col items-center gap-6  pb-16 pt-20">
                ...
                <p className="max-w-3xl  text-base leading-7 text-gray-700 sm:text-lg">
                  Moving in the UAE should be simple, affordable, and
                  hassle-free. Our expert movers and packers ensure every
                  relocation is seamless with clear pricing and reliable
                  service. From a small studio to a large villa, our skilled
                  team is ready to make your move easy.
                </p>
                <div className="mt-2 max-w-3xl  text text-gray-600">
                  From bustling Dubai to Abu Dhabi and beyond, we serve the
                  entire UAE. No job is too big or small – residential or
                  commercial, we handle moves of all sizes. Our friendly team
                  and attention to detail ensure your move is smooth from start
                  to finish.
                </div>
            ...
            <Section id="pricing" title="Transparent Pricing for Every Home">
              ...
              <p className="mt-6 text-sm text-gray-600">
                ...
                packing, heavy lifting, or furniture assembly can affect the
                final cost. Feel free to reach out and tell us about your move –
                we’ll tailor a quote that covers all your needs.
              </p>
            </Section>
            <Section id="moving-solutions" title="Tailored Moving Solutions">
              ...
              <p className="b-text">
                ...
                specifics are factored into your customized quote, so there are
                no hidden fees. Simply tell us your moving date and preferences,
                and we’ll create a plan that fits your timeline and budget.
              </p>
            </Section>
