...
import { serviceFaqs } from "@/lib/raws";
  ...
  return (
    <>
      ...
      <Script
        ...
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(serviceFaqs),
        }}
      >
        {" "}
      </Script>
        ...
        <section className="w-full h-[450px] relative ">
          ...
          <div className="flex flex-col items-start justify-center absolute w-full h-full top-0 left-0 bg-gradient-to-r from-white/75 via-white/75 md:via-white/50 md:to-white/25 to-white/50 md:px-20 px-3">
            ...
            <p className="mt-5 b-text max-w-2xl md:text-lg">
              ...
              across the UAE. From apartments to villas, our licensed team
              ensures a smooth, safe, and stress-free relocation.
            </p>
        ...
        <ContactSection
          ...
          desc={
            <>
              ...
              <p>
                Request reliable moving services in the UAE with Samana Movers.
                We ensure smooth apartment and villa relocations with expert
                packing and safe transport.
              </p>
            </>
          }
        />
        ...
        <div className="mt-32 md:w-11/12 mx-auto md:px-0 px-3 grid md:grid-cols-2 grid-cols-1 gap-16">
          ...
          <div>
            ...
            <p className="mt-3 b-text">
              ...
              for you. You can get more details by call us or fill the quote
              form.
            </p>
            <div className=" mt-10">
