...
import { aboutFaqs } from "@/lib/raws";
const services = [
  {
  ...
  return (
    <>
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                position: 2,
                name: "About Us",
                item: "https://www.samanamoversuae.com/about-us",
              },
            ],
          }),
        }}
      ...
      <Script
        ...
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(aboutFaqs),
        }}
      >
        {" "}
      </Script>
      <main>
              ...
              <div className="w-full px-4 lg:w-1/2 xl:w-5/12 md:order-2 order-1">
                <div className="mt-10 lg:mt-0">
                  ...
                  <p className="mb-5 text-base b-text">
                    ...
                    established in 2018, specializing in seamless home
                    relocations across the UAE.
                  </p>
        ...
        <section className="md:px-0 px-3 mt-36 max-w-5xl mx-auto">
          <p className="b-text mt-5 md:text-xl text-lg">
            ...
            fully licensed team provides professional service at affordable
            rates.
          </p>
          <p className="b-text mt-2 md:text-xl text-lg">
            Customers know us as one of the most affordable movers UAE – we
            offer clear, all-inclusive quotes, quality packing materials, and
          ...
          <div className="md:pl-16">
            ...
            <div className="mt-5 b-text">
              ...
              <p>
                ...
                of our team is trained, background-checked, and equipped to
                handle your home with care.
              </p>
              <p>
                Our multilingual staff (fluent in English and Arabic)
                understands the UAE’s unique moving regulations and logistics.
              </p>
              <p>
              ...
              <p>
                With Samana Movers, you get a dedicated partner who will plan
                and execute your move meticulously, giving you confidence at
                every step.
              </p>
            </div>
          </div>
        ...
        <section className="md:px-20 py-16 b1-bg px-3 mt-36  mx-auto">
          ...
          <p className="b-white mt-5">
            We offer a full range of home moving services (clickable links in
            our website menu)
          </p>
          ...
          <ul className="grid md:grid-cols-3 grid-cols-1 gap-10 mt-10">
            ...
            <li className="p-5 b2-bg b1 flex flex-col gap-y-3">
              ...
              <p className="text-sm">
                Inter-emirate relocations across the UAE, including
                Sharjah–Dubai and Sharjah–Abu Dhabi moves, with GPS-tracked
                transport.
              </p>
            </li>
            <li className="p-5 b2-bg b1 flex flex-col gap-y-3">
          ...
          <p className="b-white mt-10 max-w-2xl">
            Each service is handled by our trained crews. We use modern trucks
            and professional equipment (dollies, ramps, straps) to ensure safe
            transit for every item.
          </p>
        </section>
        ...
        <section className="flex flex-col lg:flex-row items-center justify-between md:w-11/12 mx-auto mt-36 md:px-0 px-3">
          ...
          <div className="lg:w-1/2 w-full">
            ...
            <p className="b-text">
              (For example, Khimji Ramdas notes that trusted movers cover
              “Dubai, Abu Dhabi, and Sharjah” – and we do, too .) Just tell us
              your pick-up and drop-off locations, and we’ll take care of the
              rest
            </p>
          </div>
          ...
          <div className="mt-16 grid md:grid-cols-2 grid-cols-1 md:gap-x-10 gap-y-10">
            <div>
              ...
              <div className="b-text mt-5">
                <p>
                  Sharjah–Dubai Apartment Move: A family needed to relocate from
                  a 3-bedroom apartment in Sharjah to a new flat in Jumeirah,
                  Dubai.{" "}
                </p>
                <p>
                ...
                <p>
                  We carefully packed all kitchenware, electronics, and
                  furniture. Despite heavy Friday traffic, we completed the 50
                  km move in one day.
                </p>
                <p>
                ...
                <p>
                  This case highlights our house shifting Dubai expertise, even
                  on a tight schedule.
                </p>
              </div>
            </div>
          ...
          faqs={[
              ...
              answer: (
                <>
                  <p>
                    ...
                    Dhabi, and Ajman. Whether you live in Dubai Marina or a
                    suburb of Ajman, we cover the entire region with our
            ...
            },
            {
              ...
              answer: (
                <>
                  <p>
                    Samana Movers specializes in residential relocations. We
                    move homes of all sizes – apartments, villas, and family
                    houses.
                  </p>
                  <p>
              ...
              answer: (
                <>
                  ...
                  <p>
                    ...
                    pricing. We’ll give you a customized quote after an
                    estimate, as suggested by UAE relocation experts
                  </p>
                </>
              ),
            },
            {
              ...
              answer: (
                <>
                  ...
                  <p>
                    This means if anything unforeseen happens, you’re covered.
                    As one UAE mover explains, this insurance “provides peace of
            ...
            },
            {
              ...
              answer: (
                <>
                  ...
                  <p>
                    Either way, we ensure everything is labeled and organized
                    for an easy unpack.
                  </p>
                </>
              ),
            ...
            },
            {
              ...
              answer: (
                <>
                  <p>
                    We strive to be flexible. Samana Movers can schedule moves
                    on Saturdays or Sundays, and even on UAE public holidays
            ...
            },
            {
              ...
              answer: (
                <>
                  <p>
                    Moving yourself often seems cheaper, but it can lead to
                    hidden costs and hassles – renting a truck, buying packing
                    supplies, and risking injury or damage.
                  </p>
                  <p>
