    ...
    <main className="max-w-[1400px] mx-auto">
      <section className="w-full h-[500px] relative ">
        ...
        <div className="flex flex-col items-start justify-center absolute w-full h-full top-0 left-0 bg-gradient-to-r from-white/75 via-white/75 md:via-white/50 md:to-white/25 to-white/50 md:px-20 px-3">
          ...
          <p className="mt-5 b-text max-w-2xl md:text-lg">
            ...
            throughout the United Arab Emirates. With years of experience and a
            dedicated team of professionals, we ensure seamless relocations
      ...
      <section className="mt-32 grid md:grid-cols-2 grid-cols-1 items-center md:w-11/12 mx-auto">
        ...
        <div className="md:px-20 px-3 py-14 bg-white drop-shadow-xl md:-ml-16 z-10">
          ...
          <p className="md:mt-7 mt-5 text-[#5e5e5e]">
            Whether you&lsquo;re moving your home, office, or commercial space,
            our expert movers and packers are available across the UAE&lsquo;s
            most vibrant emirates.We understand the unique requirements of each
            location and provide tailored moving solutions to meet your specific
            needs.
          </p>
      ...
      >
        ...
        <p className="b-text max-w-3xl mt-5">
          ...
          shifting, office relocation, and packing services throughout Dubai and
          all its districts.
        </p>
        <h4 className="my-5 font-bold b1 text-xl">Areas We Cover in Dubai:</h4>
        <ul className="b-text flex gap-5 flex-wrap ">
          ...
          <li className="lis">All other Dubai neighborhoods and communities</li>
        </ul>
      ...
      <div className="grid md:grid-cols-2 grid-cols-1">
        ...
        >
          ...
          <p className="text-gray-300 max-w-3xl mt-5">
            As the UAE&lsquo;s capital, Abu Dhabi requires moving services that
            understand both residential luxury and corporate professionalism.
            Samana Movers delivers exceptional moving experiences across Abu
            Dhabi&lsquo;s diverse neighborhoods.
          </p>
      ...
      >
        ...
        <h4 className="my-5 font-bold b1 text-xl">Areas We Cover in Ajman:</h4>
        <ul className="b-text flex gap-5 flex-wrap ">
          ...
          <div className="grid grid-cols-1  lg:grid-cols-2 gap-10 mt-20">
            ...
            >
              ...
              <p className={`b-white text-sm`}>
                We don&lsquo;t just serve the main cities – our network extends
                to every community, district, and neighborhood within each
                emirate. From luxury villas in Emirates Hills to apartments in
                International City, we&lsquo;re there when you need us.
              </p>
            </div>
            <div
              className={` p-5 border-b-2 border-[#fcd200] 
            ...
            >
              ...
              <p className={`b-white text-sm`}>Our teams are familiar with:</p>
            ...
            >
              ...
              <p className={`b-white text-sm`}>
                We have professional standards when its comes to moving in UAE:
              </p>
              <ul className="grid md:grid-cols-2 b-white text-sm gap-2 mt-2">
                <li>
                  Licensed & Insured: Fully authorized to operate across all UAE
                  emirates
                </li>
                <li>
