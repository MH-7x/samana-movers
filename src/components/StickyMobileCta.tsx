...
const StickyMobileCta = () => {
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 mx-auto w-full max-w-lg px-3 pb-4 ">
      <div className="mx-0  border border-[#fcd200] bg-white/90 p-5 shadow-xl rounded-lg">
