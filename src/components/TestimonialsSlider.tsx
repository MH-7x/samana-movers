...
const testimonials = [
  {
    ...
    rating: 5,
    feedback:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Phasellus facilisis malesuada blandit orci hendrerit.",
  },
  {
    id: 2,
    name: "Sarah Johnson",
