          ...
          <div className="md:-mx-4 -mx-2 flex flex-wrap">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                <Link href="/" className="mb-6 inline-block max-w-[230px]">
                  <Image
                    src={"/logo-white.svg"}
                    alt="company logo"
                    width={600}
                ...
                <p className="mb-7 text-sm text-body-color dark:text-dark-6">
                  Samana Movers is your trusted partner for house shifting in
                  the UAE. Our 50+ trained packers and movers handle apartment
              ...
              <div className="mb-10 w-full">
                ...
                <div className="mb-6 flex items-center">
                  <a
                    ...
                    className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-stroke text-dark hover:border-[#f2f2f2] hover:bg-[#fcd200] hover:text-[#182937] sm:mr-4 lg:mr-3 xl:mr-4"
                  >
                    <svg
                      width="8"
                      height="16"
...
const NavLink = ({ link, label }: { link: string; label: string }) => {
  return (
    <li>
      <a
        href={link}
        className="inline-block text-sm leading-loose hover:underline underline-offset-2 hover:text-[#fcd200]"
      >
        {label}
      </a>
    </li>
